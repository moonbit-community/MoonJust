...
phase_packages="source diagnostic path host cli lexer syntax parser formatter"
...
pure_packages="source diagnostic path cli lexer syntax parser formatter"
...
echo "architecture boundaries verified for nine Phase 1-3 packages"
