...
phase_packages="source diagnostic path host cli lexer syntax parser formatter semantic loader"
...
pure_packages="source diagnostic path cli lexer syntax parser formatter semantic"
...
echo "architecture boundaries verified for eleven Phase 1-4 packages"
